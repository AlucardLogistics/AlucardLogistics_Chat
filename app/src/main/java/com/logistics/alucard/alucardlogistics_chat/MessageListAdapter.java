...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public MessageListAdapter(List<Messages> mMessageList, Context context) {
        ...
        void bind(Messages message) {
            ...
            mUserDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Picasso.get().load(thumbImage).into(thumbProfileImage);
                }
    ...
    private class ReceivedImageHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Toast.makeText(receivedImagecontext, "Received Clicked!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private class SentImageHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        private String imgUrl, messageType, messageID, mCurrentUserID, mChatUserID;
        ...
        void bind(Messages message) {
            ...
            if (messageType.equals("image")) {
                Picasso.get().load(message.getMessage()).placeholder(R.drawable.defaultphoto).into(messageImage);
                Log.d(TAG, "onBindViewHolder: ImageUrl: " + message.getMessage());
            }
        ...
        public boolean onLongClick(final View view) {
            ...
            String mCurrentUserPath = mCurrentUserID + "/" + mChatUserID + "/" + messageID;
            String mChatUserPath = mChatUserID + "/" + mCurrentUserID + "/" + messageID;
